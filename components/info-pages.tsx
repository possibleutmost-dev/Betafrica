...
export function TermsPage() {
  return (
    <InfoPage
      ...
      intro="These terms form the agreement between you and BetAfrica when you open an account, deposit, place a bet or play a game. Please read them carefully. By registering or using the site you confirm that you accept them."
    >
      <Part n={1} title="Who can play">
        <ul>
          ...
          <li>Staff of BetAfrica and their immediate families may not bet on the site.</li>
        </ul>
      </Part>
...
export function PrivacyPage() {
  return (
    <InfoPage
      ...
      intro="This policy explains what personal information BetAfrica collects, why we need it, and the choices you have."
    >
  ...
  return (
    <footer className={`bg-[#eef0f4] px-3 pb-28 pt-6 md:pb-8 ${className}`}>
      <div className="mx-auto max-w-[1180px] rounded-2xl border border-[#e2e8f0] bg-white px-5 py-8 text-center">
        ...
        <p className="mt-5 text-xs text-[#94a3b8]">© {year} BetAfrica. All Rights Reserved.</p>
      </div>
    </footer>
  )
}
