  ...
  return (
    <section className="mx-auto max-w-[820px] px-3 py-4 sm:px-4 sm:py-8">
      ...
      <nav className="mt-4 flex flex-wrap gap-x-4 gap-y-2 px-1 text-sm text-[#6b7077]">
        <Link href="/terms" className="hover:text-[#ed1324]">Terms &amp; Conditions</Link>
        <Link href="/privacy" className="hover:text-[#ed1324]">Privacy Policy</Link>
        <Link href="/responsible-gambling" className="hover:text-[#ed1324]">Responsible Gambling</Link>
        <Link href="/help" className="hover:text-[#ed1324]">Help &amp; FAQ</Link>
      </nav>
    </section>
  )
}
    ...
    <InfoPage title="Help & FAQ" intro="Quick answers to common questions. Can't find what you need? Contact us below.">
      ...
      <Part title="Contact Customer Service">
        <div id="contact" className="grid gap-3 sm:grid-cols-2">
          ...
          {info.support_email && (
            <a href={`mailto:${info.support_email}`} className="flex items-center gap-3 border p-4 hover:border-[#ed1324]">
              <Mail className="text-[#ed1324]" />
...
export function SiteFooter({ className = '' }: { className?: string }) {
  ...
  return (
    <footer className={`bg-[#eef0f4] px-3 pb-28 pt-6 md:pb-8 ${className}`}>
      <div className="mx-auto max-w-[1180px] rounded-2xl bg-white px-5 py-8 text-center shadow-sm">
        ...
        <p className="mt-5 text-3xl font-black italic tracking-[-1.5px] text-[#ed1324]">WinnBet</p>
